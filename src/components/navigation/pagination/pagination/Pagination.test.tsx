...
import { paginationItemClasses } from '../paginationItem/paginationItemClasses';
import { Pagination } from './Pagination';
import { paginationClasses } from './paginationClasses';

const classes = generatePrefixClasses(paginationClasses, 'Pagination');
const itemClasses = generatePrefixClasses(paginationItemClasses, 'PaginationItem');
